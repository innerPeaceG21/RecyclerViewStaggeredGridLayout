...
import com.bettermyselfllc.recyclerviewstaggeredgridlayout.databinding.FlowerItemBinding
...
class FlowerAdapter(
    ...
    class ViewHolder(var flowerItemBinding: FlowerItemBinding) :
        RecyclerView.ViewHolder(flowerItemBinding.root) {
